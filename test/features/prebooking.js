...
Feature('Pre-bookings: ', () => {
  ...
  Scenario('Remove Existing Pre-bookings at 7am', () => {
  ...
  Scenario('Ignore Future Pre-bookings: Pre 6:59am Tomorrow', () => {
  ...
  Scenario('Ignore Past Pre-bookings: Pre 7am Today', () => {
  ...
  Scenario('Consider Todays Pre-bookings: 7am - 6:59am', () => {
