...
//     it('should update and not create if Detainee already exists', () => {
//       sinon.stub(Detainees, 'update').resolves(true);
//       sinon.stub(Detainees, 'create').resolves(false);

//       return controller.saveDetainee(fake_request_body).then(() => {
//         expect(Detainees.create).to.have.not.been.called;
//         expect(Detainees.update).to.be.calledWith(
//           {
//             id: expected_detainee.id
//           },
//           expected_detainee
//         );

//         Detainees.create.restore();
//         Detainees.update.restore();
//       });

//     });

//     it('should create if Detainee doesnt exist', () => {
//       sinon.stub(Detainees, 'update').resolves([]);
//       sinon.stub(Detainees, 'create').resolves(true);

//       return controller.saveDetainee(fake_request_body).then(() => {
//         expect(Detainees.create).to.be.calledWith(expected_detainee);
